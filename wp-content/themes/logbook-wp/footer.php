...
$copyright = get_theme_mod('logbook_wp_copyright',esc_html__('Proudly Powered By WordPress', 'logbook-wp'));
?>
    ...
    <button onclick="topFunction()" id="myBtn" title="<?php echo esc_attr("Go to top", 'logbook-wp') ?>">
